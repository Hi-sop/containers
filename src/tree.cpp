...
namespace ft
{
	...
	static void local_insert_new_node
		(const bool __insert_left, __tree_node_base *&__x,
	...
	static void local_erase_node(__tree_node_base *const &__z,
			...
			__tree_node_base *&__x_p, __tree_node_base &__header)
	{
		__tree_node_base *&__root = __header.__parent_;
	...
	inline static bool local_erase_fixup_left
		(__tree_node_base *&__x, __tree_node_base *&__x_p,
		 __tree_node_base *&__root)
		{
	...
	inline static bool local_erase_fixup_right(__tree_node_base *&__x,
			__tree_node_base *&__x_p, __tree_node_base *&__root)
	{
