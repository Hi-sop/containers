...
namespace ft
{
	...
	struct __has_iterator_typedefs
	{
		...
		static char __test(
				...
				typename ft::void_t<typename _U::value_tpye>::type * = 0,
	...
	difference_type operator-(const reverse_iterator<_Iter1> &__lhs,
			const reverse_iterator<_Iter2> &__rhs) 
	{
	...
	inline typename iterator_traits<_RandIterator>::difference_type 
	__distance(_RandIterator __first, _RandIterator __last,
